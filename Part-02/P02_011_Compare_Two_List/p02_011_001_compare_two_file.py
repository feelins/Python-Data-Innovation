...
def uniq_list():
    """检查1100W不重复情况"""
    input_book_list_file = r'D:\007_LLM\20240603-duxiu-not\大学堂原始文件信息\大学堂原始文件信息.txt'
    output_error_file = r'D:\007_LLM\20240603-duxiu-not\大学堂原始文件信息_error_id.txt'
    output_id_stats_file = r'D:\007_LLM\20240603-duxiu-not\大学堂原始文件信息_ids.txt'
    errors = []
    total_ids = {}
    tmp_index = 0
...
def compare_two_list():
    input_not_found_file = r'D:\007_LLM\20240603-duxiu-not\booklist_loss_simple\booklist_loss_simple.txt'
    input_ref_check_file = r'D:\007_LLM\20240603-duxiu-not\大学堂原始文件信息\大学堂原始文件信息.txt'

    output_check_file = r'D:\007_LLM\20240603-duxiu-not\大学堂原始文件信息_need_download.json'
